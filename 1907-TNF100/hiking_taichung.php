...
<?php 
  ...
  <meta property="og:image" content="http://www.xn--djr420n.tw/images/share/hiking_taichung_share.jpg" />
...
<body class="activetiesTemplate hikingPage noSignUp" data-hint="outdoorTrainingPage">
  <!-- Loading -->
  <div class="loading">
    <div>
      <div class="c1"></div>
  ...
  <main>
    ...
    <section class="kv">
      ...
      <!-- Sessions -->
      <a class="session session1" href="./hiking_taipei.php">
        <p>台北<br>三貂嶺</p>
        <picture>
      ...
      <a class="session session2 selected" href="./hiking_taichung.php">
        <p>台中<br>大肚萬里長城</p>
        <picture>
          <source media="(min-width: 769px)" srcset="images/icon/session_icon.png">
          <source media="(min-width: 561px)" srcset="images/icon/session_icon@2x.png">
    ...
    <section class="banner">
      <div class="container">
        <h2><span>【活動】The North Face無痕山林體驗日系列活動</span><span>台中萬里長城步道淨山去！</span></h2>
        ...
        <article>
          <section>
            ...
            <div class="block">
              <p>The North Face與健行筆記共同舉辦「北面無痕山林體驗日系列活動」，10/6(六)要帶大家前往台中大肚的萬里長城步道淨山。當日除了清理步道上的垃圾，更將進一步分享無痕山林七大準則概念，教你如何在親近山林的同時減少人為環境衝擊。這麼棒的活動，還不快跟我們一起出發！</p>
            </div>
          </section>
        </article>
      </div>
      ...
      <div class="bannerBlock">
        <div class="container">
          <picture>
            <source media="(min-width: 769px)" srcset="images/hiking_taichung_banner.gif">
            <img src="images/hiking_taichung_banner.gif" alt="無痕山林體驗日系列活動，新北三貂嶺">
          </picture>
        </div>
      </div>
    </section>
    ...
    <section class="introduction articleSec _bgc_gray">
      <div class="container">
        ...
        <article>
          <section>
            <div class="block">
              <p>活動時間：2018年10月06日（星期六）9：00~16：00</p>
              <p>集合時間與地點：上午9：00於台中區監理所集合</p>
              <p>大眾交通方式：可於台中火車站搭乘台中客運323、325線，於台中區監理所站下車（323線路線圖、325線路線圖）</p>
              <p>報名時間：即日起至9月27日，限額30名，額滿為止（逾期未完成繳費手續者，報名系統將自動取消其報名資格）</p>
          ...
          <section>
            ...
            <div class="block">
              ...
              <p>大肚萬里長城步道－旗開得勝步道－蝴蝶谷小環線，預計16:00結束</p>
            </div>
            <div class="block">
    ...
    <section class="course articleSec _bgc_gray">
      <div class="container">
        ...
        <article>
          <section>
            <div class="block">
              <p class="subTitle">大肚萬里長城步道簡介</p>
              <p>萬里長城步道蜿蜒於稜線上連綿不絕，有如萬里長城，因而得名。步道輕鬆好走、全程綠樹成蔭，高點的「享壽亭」可眺望台中港區、火力發電廠，展望優美。續接的旗開得勝步道則較為自然原始，途經蝴蝶谷自然生態園區，自然生態豐富，是大肚區熱門的健行步道。</p>
              <p>也因遊客眾多，山徑旁日積月累諸多垃圾，本系列活動除推廣無痕山林理念，更將與你一起身體力行，立刻把垃圾撿下山！</p>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_taichung_pic_01.jpg">
                <img src="images/hiking_taichung_pic_01.jpg" alt="照片">
              </picture>
              <span>步道上的遼闊展望（圖／張介禹）</span>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_taichung_pic_02.jpg">
                <img src="images/hiking_taichung_pic_02.jpg" alt="照片">
              </picture>
              <span>沿途綠意盎然（圖／張介禹）</span>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_taichung_pic_03.jpg">
                <img src="images/hiking_taichung_pic_03.jpg" alt="照片">
              </picture>
              <span>獨特的石灰岩洞穴，令人駐足留連（圖／張介禹）</span>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_taichung_pic_04.jpg">
                <img src="images/hiking_taichung_pic_04.jpg" alt="照片">
              </picture>
              <span>美麗景緻，需要我們共同維護 （圖／Bala Wu）</span>
            </div>
          </section>
        </article>
      </div>
    ...
    <section class="googleMap _bgc_gray">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3640.473800939281!2d120.57106931478872!3d24.15511087911235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34693fb2a89cbcb9%3A0x9afe3a8ae4f4b5e1!2z5Lqk6YCa6YOo5YWs6Lev57i95bGA6Ie65Lit5Y2A55uj55CG5omA!5e0!3m2!1szh-TW!2stw!4v1538644475881" frameborder="0" style="border:0" allowfullscreen></iframe>
    </section>
