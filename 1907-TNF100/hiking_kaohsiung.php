...
<head>
  ...
  <meta property="og:image" content="http://www.xn--djr420n.tw/images/share/hiking_kaohsiung_share.jpg" />
...
<body class="activetiesTemplate hikingPage noSignUp" data-hint="outdoorTrainingPage">
  ...
  <main>
    ...
    <section class="kv">
      ...
      <a class="session session3 selected" href="./hiking_kaohsiung.php">
        <p>高雄<br>大崗山</p>
        <picture>
          <source media="(min-width: 769px)" srcset="images/icon/session_icon.png">
          <source media="(min-width: 561px)" srcset="images/icon/session_icon@2x.png">
    ...
    <section class="banner">
      <div class="container">
        <h2><span>【活動】The North Face無痕山林體驗日系列活動</span><span>高雄大崗山淨山去！</span></h2>
        ...
        <article>
          <section>
            ...
            <div class="block">
              <p>The North Face與健行筆記共同舉辦「北面無痕山林體驗日系列活動」，9/30(日)要帶大家前往名列小百岳的高雄大崗山淨山。當日除了清理步道上的垃圾，更將進一步分享無痕山林七大準則概念，教你如何在親近山林的同時減少人為環境衝擊。這麼棒的活動，還不快跟我們一起出發！</p>
            </div>
          </section>
        </article>
      </div>
      ...
      <div class="bannerBlock">
        <div class="container">
          <picture>
            <source media="(min-width: 769px)" srcset="images/hiking_kaohsiung_banner.gif">
            <img src="images/hiking_kaohsiung_banner.gif" alt="無痕山林體驗日系列活動，新北三貂嶺">
          </picture>
        </div>
      </div>
    </section>
    ...
    <section class="introduction articleSec _bgc_gray">
      <div class="container">
        ...
        <article>
          <section>
            <div class="block">
              <p>活動時間：2018年9月30日（星期日）9：00~15：00</p>
              <p>集合時間與地點：上午9：00於大崗山停車場集合</p>
              <p>大眾交通方式：</p>
              <ul>
                <li>
                  <p>@ 於捷運南崗山站搭乘紅70至九鬮站下車，步行約1.3公里即可抵達</p>
                </li>
                <li>
                  <p>@ 於捷運南崗山站搭乘大岡山假日觀光公車，於菩提登山步道入口下車即可抵達</p>
                </li>
              </ul>
              <p>報名時間：即日起至9月20日，限額30名，額滿為止（逾期未完成繳費手續者，報名系統將自動取消其報名資格）</p>
          ...
          <section>
            ...
            <div class="block">
              ...
              <p>大崗山停車場→菩提大道→龍湖庵→十方涼亭→十八羅漢洞→天靈洞→三角公園→大崗山→三角公園→超峰寺→千級石階→大崗山停車場，預計15:00結束</p>
            </div>
            <div class="block">
            ...
            <!-- <div class="block">
                ...
                <p>我們將於10/1(一)抽出三名幸運得獎者，把好康寄到你家。請注意，貼文需設定為公開，並 <font class="tag">#TNF無痕山林體驗日</font> <font class="tag">#TheNorthFaceTaiwan</font>，我們才抽得到你喔！</p>
            </div>
            <div class="block picBlock">
              <picture>
    ...
    <section class="course articleSec _bgc_gray">
      <div class="container">
        ...
        <article>
          <section>
            <div class="block">
              <p class="subTitle">高雄大崗山步道簡介</p>
              <p>大崗山名列小百岳之一，沿途樹蔭濃密、走起來清涼爽快，而且步道展望一級棒，不需走到山頂，就有多處平台可遠眺平原景緻；再加上特殊的石灰岩洞穴地形，生態地質景觀豐富，近年已成為熱門登山健行路線。</p>
              <p>也因遊客眾多，山徑旁日積月累諸多垃圾，本系列活動除推廣無痕山林理念，更將與你一起身體力行，立刻把垃圾撿下山！</p>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_kaohsiung_pic_01.jpg">
                <img src="images/hiking_kaohsiung_pic_01.jpg" alt="照片">
              </picture>
              <span>合谷瀑布氣勢磅礡（圖／Lile Hsing）</span>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_kaohsiung_pic_02.jpg">
                <img src="images/hiking_kaohsiung_pic_02.jpg" alt="照片">
              </picture>
              <span>原始山徑充滿野趣（圖／Lile Hsing）</span>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_kaohsiung_pic_03.jpg">
                <img src="images/hiking_kaohsiung_pic_03.jpg" alt="照片">
              </picture>
              <span>沿著索橋跨溪，趣味十足（圖／Lile Hsing）</span>
            </div>
            <div class="block picBlock">
              <picture>
                <source media="(min-width: 769px)" srcset="images/hiking_kaohsiung_pic_04.jpg">
                <img src="images/hiking_kaohsiung_pic_04.jpg" alt="照片">
              </picture>
    ...
    <section class="googleMap _bgc_gray">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117680.93172627127!2d120.28116505747371!3d22.819905727692582!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x346e0d5ba1d6a919%3A0xeb7015ba801fec7!2z5aSn5bSX5bGx5YGc6LuK5aC0!5e0!3m2!1szh-TW!2stw!4v1538644534032" frameborder="0" style="border:0" allowfullscreen></iframe>
    </section>
