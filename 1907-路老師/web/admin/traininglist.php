...
<html>
    ...
    <body>
        <div id="mainPageLayout" class="comRange">
            ...
            <div id="mainContent">
                ...
                <table class="searchtable" width="100%" cellspacing="0" cellpadding="7" id="fn_table" style="border:1px solid #ccc;margin:0;line-height:24px;">
                    <tr>
                        <td>
                            場次:<input type="text" class="schParam" name="title">
                            類別:
                            <select class="schParam" name="type">
                                <option value="0">全部</option>
                                <option value="1">初訓</option>
                                <option value="2">回訓</option>
                            </select>
                            年度:
                            <input type="text" class="schParam" name="year">
                            上架狀態:
                ...
                <table class="datatable" align="center" width="100%" style="display:none;">
                    <tr>
                        ...
                        <th style="text-align:center;width:10%;">年度</th>
                        <th style="text-align:center;width:10%;">類別</th>
                        <th style="text-align:center;width:10%;">場次</th>
                        <th style="text-align:center;width:10%;">培訓地點</th>
                        <th style="text-align:center;width:15%;">開課日期</th>
                        <th style="text-align:center;width:10%;">上架狀態</th>
        ...
        (function(){
                        ...
                        if(data.msgcode == 200){
                            $.each(data.data,function(i,v){
                                $('.datatable').append('<tr data-id="'+v.id+'">\
                                    ...
                                    <td>'+v.title+'</td>\
                                    <td>'+v.location+'</td>\
                                    <td>'+(v.sdate==v.edate?v.sdate:v.sdate+'~'+v.edate)+'</td>\
                                    ...
                                    <td>\
                                        <a class="memBtn" href="javascript:;">名單管理</a>\
                            ...
                            $('.memBtn').click(function(){
                                location.href = 'trainingmemberlist.php?id='+$(this).closest('tr').data('id');
                            });
                            
                            $('.editBtn').click(function(){
                                location.href = 'trainingedit.php?id='+$(this).closest('tr').data('id');
                            });
            ...
            $('#add').click(function(){
                location.href = 'trainingedit.php';
            });
