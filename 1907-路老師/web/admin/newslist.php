...
<html>
    ...
    <body>
        <div id="mainPageLayout" class="comRange">
            ...
            <div id="mainContent">
                ...
                <table class="searchtable" width="100%" cellspacing="0" cellpadding="7" id="fn_table" style="border:1px solid #ccc;margin:0;line-height:24px;">
                    <tr>
                        <td>
                            標題:<input type="text" class="schParam" name="title">
                            發布日期:
                            ...
                            <select class="schParam" name="type">
                                ...
                                <option value="<?php echo $i;?>"><?php echo $NEWSTYPE[$i];?></option>
                                <?php }?>
                            </select>
                            上架狀態:
                ...
                <table class="datatable" align="center" width="100%" style="display:none;">
                    <tr>
                        ...
                        <th style="text-align:center;width:10%;">標題</th>
                        <th style="text-align:center;width:10%;">發布日期</th>
                        <th style="text-align:center;width:10%;">縮圖</th>
        ...
        (function(){
            var NEWSTYPE = JSON.parse('<?php echo json_encode($NEWSTYPE);?>');
            var page = 1;
                        ...
                        if(data.msgcode == 200){
                            $.each(data.data,function(i,v){
                                $('.datatable').append('<tr data-id="'+v.id+'">\
                                    <td>'+v.id+'</td>\
                                    <td>'+(NEWSTYPE[v.type]||'')+'</td>\
                                    <td>'+v.title+'</td>\
                                    <td>'+v.publishdate+'</td>\
                                    <td>'+(v.cover?'<img src="../upload/'+v.cover+'">':'')+'</td>\
                            ...
                            $('.editBtn').click(function(){
                                location.href = 'newsedit.php?id='+$(this).closest('tr').data('id');
                            });
