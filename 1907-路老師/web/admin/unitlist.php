        ...
        (function(){
            ...
            function addRecord(rec){
                var $rec = $('<tr data-id="'+(rec?rec.id:'')+'">\
                        ...
                        <td>\
                            <a class="subBtn" href="javascript:;">附屬單位管理</a>\
                ...
                $rec.find('.subBtn').click(function(){
                    location.href = 'subunit.php?id='+$(this).closest('tr').data('id');
                });
