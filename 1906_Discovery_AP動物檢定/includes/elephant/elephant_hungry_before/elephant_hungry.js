...
(lib.hunger_txt_before_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// stage content:
(lib.elephant_hungry = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(434.7,277,342.7,207);
// library properties:
lib.properties = {
