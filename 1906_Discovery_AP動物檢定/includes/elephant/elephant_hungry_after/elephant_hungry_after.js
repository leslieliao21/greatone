...
(lib.hunger_txt_after = function() {
	this.initialize(img.hunger_txt_after);
}).prototype = p = new cjs.Bitmap();
...
(lib.hunger_txt_after_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.hunger_txt_after();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.hunger_txt_after_1, new cjs.Rectangle(0,0,335,140), null);
...
// stage content:
(lib.elephant_hungry_after = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// hunger_txt_after
	this.instance = new lib.hunger_txt_after_1();
	this.instance.parent = this;
	this.instance.setTransform(584.5,93,1,1,0,0,0,167.5,70);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({x:594.5,alpha:1},4).to({x:383.5},75).wait(1));
...
p.nominalBounds = new cjs.Rectangle(437,273,340.4,211);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/body.png?1559279943538", id:"body"},
		{src:"images/eye.png?1559279943538", id:"eye"},
		{src:"images/eye_2.png?1559279943538", id:"eye_2"},
		{src:"images/head.png?1559279943538", id:"head"},
		{src:"images/hunger_txt_after.png?1559279943538", id:"hunger_txt_after"},
		{src:"images/left_back_b.png?1559279943538", id:"left_back_b"},
		{src:"images/left_back_s.png?1559279943538", id:"left_back_s"},
		{src:"images/left_front_b.png?1559279943538", id:"left_front_b"},
		{src:"images/left_front_s.png?1559279943538", id:"left_front_s"},
		{src:"images/nose.png?1559279943538", id:"nose"},
		{src:"images/shadow.png?1559279943538", id:"shadow"},
		{src:"images/tail.png?1559279943538", id:"tail"},
		{src:"images/tooth.png?1559279943538", id:"tooth"},
		{src:"images/tooth_s.png?1559279943538", id:"tooth_s"}
	],
	preloads: []
};
