...
(lib.mud_1 = function() {
	this.initialize(img.mud_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,52,107);


(lib.mud_2 = function() {
	this.initialize(img.mud_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,84,53);


(lib.mud_3 = function() {
	this.initialize(img.mud_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,188,143);


(lib.mud_4 = function() {
	this.initialize(img.mud_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,42,54);


(lib.mud_5 = function() {
	this.initialize(img.mud_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,47,122);


(lib.mud_7 = function() {
	this.initialize(img.mud_7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,34,47);


(lib.mud_txt_after = function() {
	this.initialize(img.mud_txt_after);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,356,149);


(lib.nose_2 = function() {
	this.initialize(img.nose_2);
}).prototype = p = new cjs.Bitmap();
...
(lib.nose_2_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// mud_1
	this.instance = new lib.mud_1();
	this.instance.parent = this;
	this.instance.setTransform(69,64);
...
}).prototype = getMCSymbolPrototype(lib.nose_2_1, new cjs.Rectangle(0,0,129,200), null);


(lib.mud_txt_after_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.mud_txt_after();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.9157,0.9157);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mud_txt_after_1, new cjs.Rectangle(0,0,326,136.5), null);
...
(lib.left_front_s_1 = function(mode,startPosition,loop) {
	...
	// mud_4
	this.instance = new lib.mud_4();
	this.instance.parent = this;
	this.instance.setTransform(10.1,44.6,1,1,-7.7389);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// 圖層_1
	this.instance_1 = new lib.left_front_s();
	this.instance_1.parent = this;
...
(lib.left_back_s_1 = function(mode,startPosition,loop) {
	...
	// mud_5
	this.instance = new lib.mud_5();
	this.instance.parent = this;
	this.instance.setTransform(42.4,49.5,1,1,0.7082);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// 圖層_1
	this.instance_1 = new lib.left_back_s();
	this.instance_1.parent = this;
...
(lib.head_main = function(mode,startPosition,loop) {
	...
	// mud_2
	this.instance = new lib.mud_2();
	this.instance.parent = this;
	this.instance.setTransform(94,3);
...
(lib.head_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:16.1,rotation:9.4491,x:44.1,y:173.35},15).to({regY:16,rotation:0,x:49.25,y:181.25},14).wait(1));

	// nose
	this.instance_1 = new lib.nose_2_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(21.5,151,1,1,0,0,0,103.5,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:104.4,regY:22.2,rotation:6.7589,x:17.5,y:147.2},15).to({regX:103.5,regY:22,rotation:0,x:21.5,y:151},14).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:12.6,rotation:19.4035,x:54.9,y:103.8},15).to({regX:12.5,rotation:0,x:54,y:106},14).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:5.3926,x:126.05},15).to({rotation:-1.0037,x:126.1},14).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:18.1,rotation:17.457,x:23.05,y:168.1},15).to({regY:18,rotation:0,x:23,y:168},14).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-107.1,-11.3,333.1,340.3);
...
(lib.front_back_1 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(31,62.5,1,1,0,0,0,31,62.5);
	this.instance_1.filters = [new cjs.ColorFilter(0.85, 0.85, 0.85, 1, 0, 0, 0, 0)];
	this.instance_1.cache(-2,-2,66,129);
...
(lib.body_1 = function(mode,startPosition,loop) {
	...
	// mud_3
	this.instance = new lib.mud_3();
	this.instance.parent = this;
	this.instance.setTransform(75,4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20));

	// tail
	this.instance_1 = new lib.tail_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(306.25,157.6,1,1,3.0116,0,0,7.6,13.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:7.5,rotation:-28.5865,x:306.15,y:155.65},9).to({regX:7.6,rotation:3.0116,x:306.25,y:157.6},10).wait(1));

	// body
	this.instance_2 = new lib.body_m();
	this.instance_2.parent = this;
	this.instance_2.setTransform(152.5,115.5,1,1,0,0,0,152.5,115.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(20));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,350.6,231);
...
// stage content:
(lib.elephant_mud_after = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// mud_txt_after
	this.instance = new lib.mud_txt_after_1();
	this.instance.parent = this;
	this.instance.setTransform(580,96.2,1,1,0,0,0,163,68.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({x:597,alpha:1},4).to({x:371},75).wait(1));

	// head
	this.instance_1 = new lib.head_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(477,191.5,1,1,0,0,0,139,116.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({x:422.8,y:184.5},17,cjs.Ease.get(1)).to({x:365.75,y:193.75},20,cjs.Ease.get(0.5)).to({x:305.85,y:185.65},21,cjs.Ease.get(0.6)).to({x:246,y:191.5},21).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(2).to({scaleX:0.7978,x:327.6,y:440.1},79).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(415,278,362.4,206);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/body.png?1559281876471", id:"body"},
		{src:"images/eye.png?1559281876471", id:"eye"},
		{src:"images/eye_2.png?1559281876471", id:"eye_2"},
		{src:"images/head.png?1559281876471", id:"head"},
		{src:"images/left_back_b.png?1559281876471", id:"left_back_b"},
		{src:"images/left_back_s.png?1559281876471", id:"left_back_s"},
		{src:"images/left_front_b.png?1559281876471", id:"left_front_b"},
		{src:"images/left_front_s.png?1559281876471", id:"left_front_s"},
		{src:"images/mud_1.png?1559281876471", id:"mud_1"},
		{src:"images/mud_2.png?1559281876471", id:"mud_2"},
		{src:"images/mud_3.png?1559281876471", id:"mud_3"},
		{src:"images/mud_4.png?1559281876471", id:"mud_4"},
		{src:"images/mud_5.png?1559281876471", id:"mud_5"},
		{src:"images/mud_7.png?1559281876471", id:"mud_7"},
		{src:"images/mud_txt_after.png?1559281876471", id:"mud_txt_after"},
		{src:"images/nose_2.png?1559281876471", id:"nose_2"},
		{src:"images/shadow.png?1559281876471", id:"shadow"},
		{src:"images/tail.png?1559281876471", id:"tail"},
		{src:"images/tooth.png?1559281876471", id:"tooth"},
		{src:"images/tooth_s.png?1559281876471", id:"tooth_s"}
	],
	preloads: []
};
