...
(lib.angry_1 = function() {
	this.initialize(img.angry_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,25,29);


(lib.angry_2 = function() {
	this.initialize(img.angry_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,25,29);
...
(lib.shit = function() {
	this.initialize(img.shit);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,76,63);


(lib.sweep_error_1 = function() {
	this.initialize(img.sweep_error_1);
}).prototype = p = new cjs.Bitmap();
...
(lib.eye = function(mode,startPosition,loop) {
	...
	// angry_1
	this.instance_1 = new lib.angry_1();
	this.instance_1.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true},7).wait(3).to({_off:false},0).wait(9));
...
(lib.clean_txt_before = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.sweep_error_1();
	this.instance.parent = this;
	this.instance.setTransform(-68,-13);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.clean_txt_before, new cjs.Rectangle(-68,-13,356,149), null);
...
// stage content:
(lib.sweep_error = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// clean_txt_before
	this.instance = new lib.clean_txt_before();
	this.instance.parent = this;
	this.instance.setTransform(280,92,1,1,0,0,0,150,63);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({x:260,alpha:1},4).to({x:480},75).wait(1));

	// shit
	this.instance_1 = new lib.shit();
	this.instance_1.parent = this;
	this.instance_1.setTransform(590,407,0.9781,0.9781);

	this.instance_2 = new lib.shit();
	this.instance_2.parent = this;
	this.instance_2.setTransform(484,420,0.7632,0.7632);

	this.instance_3 = new lib.shit();
	this.instance_3.parent = this;
	this.instance_3.setTransform(162,401);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(82));

	// head
	this.instance_4 = new lib.head_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(355.3,191.5,1,1,0,0,180,139,116.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({x:419.5,y:184.5},17,cjs.Ease.get(1)).to({x:476.55,y:193.75},20,cjs.Ease.get(0.5)).to({x:536.45,y:185.65},21,cjs.Ease.get(0.6)).to({x:596.3,y:191.5},21).wait(1));

	// left_front
	this.instance_5 = new lib.left_front_b_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(308.3,284,1,1,0,0,180,38,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({x:372.5,y:277},17,cjs.Ease.get(1)).to({x:429.55,y:286.25},20,cjs.Ease.get(0.5)).to({x:489.45,y:278.15},21,cjs.Ease.get(0.6)).to({x:549.3,y:284},21).wait(1));

	// left_back
	this.instance_6 = new lib.left_back();
	this.instance_6.parent = this;
	this.instance_6.setTransform(124.3,247.5,1,1,0,0,180,52,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(2).to({x:188.5,y:240.5},17,cjs.Ease.get(1)).to({x:245.55,y:249.75},20,cjs.Ease.get(0.5)).to({x:305.45,y:241.65},21,cjs.Ease.get(0.6)).to({x:365.3,y:247.5},21).wait(1));

	// body
	this.instance_7 = new lib.body_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(214.8,228.5,1,1,0,0,180,152.5,115.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(2).to({x:279,y:221.5},17,cjs.Ease.get(1)).to({x:336.05,y:230.75},20,cjs.Ease.get(0.5)).to({x:395.95,y:222.65},21,cjs.Ease.get(0.6)).to({x:455.8,y:228.5},21).wait(1));

	// left_back
	this.instance_8 = new lib.right_back();
	this.instance_8.parent = this;
	this.instance_8.setTransform(171.3,233.5,1,1,0,0,180,52,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(2).to({x:235.5,y:226.5},17,cjs.Ease.get(1)).to({x:292.55,y:235.75},20,cjs.Ease.get(0.5)).to({x:352.45,y:227.65},21,cjs.Ease.get(0.6)).to({x:412.3,y:233.5},21).wait(1));

	// left_front
	this.instance_9 = new lib.right_f();
	this.instance_9.parent = this;
	this.instance_9.setTransform(331.3,260,1,1,0,0,180,38,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(2).to({x:395.5,y:253},17,cjs.Ease.get(1)).to({x:452.55,y:262.25},20,cjs.Ease.get(0.5)).to({x:512.45,y:254.15},21,cjs.Ease.get(0.6)).to({x:572.3,y:260},21).wait(1));

	// shadow
	this.instance_10 = new lib.shadow_1();
	this.instance_10.parent = this;
	this.instance_10.setTransform(287.65,440.6,0.7662,0.977,0,0,180,317.6,44.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(2).to({scaleX:0.7978,x:496.7},79).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(427,266,350.29999999999995,218);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/angry_1.png?1561370119455", id:"angry_1"},
		{src:"images/angry_2.png?1561370119455", id:"angry_2"},
		{src:"images/body.png?1561370119455", id:"body"},
		{src:"images/head.png?1561370119455", id:"head"},
		{src:"images/left_back_b.png?1561370119455", id:"left_back_b"},
		{src:"images/left_back_s.png?1561370119455", id:"left_back_s"},
		{src:"images/left_front_b.png?1561370119455", id:"left_front_b"},
		{src:"images/left_front_s.png?1561370119455", id:"left_front_s"},
		{src:"images/nose.png?1561370119455", id:"nose"},
		{src:"images/shadow.png?1561370119455", id:"shadow"},
		{src:"images/shit.png?1561370119455", id:"shit"},
		{src:"images/sweep_error_1.png?1561370119455", id:"sweep_error_1"},
		{src:"images/tail.png?1561370119455", id:"tail"},
		{src:"images/tooth.png?1561370119455", id:"tooth"},
		{src:"images/tooth_s.png?1561370119455", id:"tooth_s"}
	],
	preloads: []
};
