...
// stage content:
(lib.elephant_general = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(459,191.5,1,1,0,0,0,139,116.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({x:404.8,y:184.5},17,cjs.Ease.get(1)).to({x:347.75,y:193.75},20,cjs.Ease.get(0.5)).to({x:287.85,y:185.65},21,cjs.Ease.get(0.6)).to({x:228,y:191.5},21).wait(1));

	// left_front
	this.instance_1 = new lib.left_front_b_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(506,284,1,1,0,0,0,38,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({x:451.8,y:277},17,cjs.Ease.get(1)).to({x:394.75,y:286.25},20,cjs.Ease.get(0.5)).to({x:334.85,y:278.15},21,cjs.Ease.get(0.6)).to({x:275,y:284},21).wait(1));

	// left_back
	this.instance_2 = new lib.left_back();
	this.instance_2.parent = this;
	this.instance_2.setTransform(690,247.5,1,1,0,0,0,52,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({x:635.8,y:240.5},17,cjs.Ease.get(1)).to({x:578.75,y:249.75},20,cjs.Ease.get(0.5)).to({x:518.85,y:241.65},21,cjs.Ease.get(0.6)).to({x:459,y:247.5},21).wait(1));

	// body
	this.instance_3 = new lib.body_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(599.5,228.5,1,1,0,0,0,152.5,115.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({x:545.3,y:221.5},17,cjs.Ease.get(1)).to({x:488.25,y:230.75},20,cjs.Ease.get(0.5)).to({x:428.35,y:222.65},21,cjs.Ease.get(0.6)).to({x:368.5,y:228.5},21).wait(1));

	// left_back
	this.instance_4 = new lib.right_back();
	this.instance_4.parent = this;
	this.instance_4.setTransform(643,233.5,1,1,0,0,0,52,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({x:588.8,y:226.5},17,cjs.Ease.get(1)).to({x:531.75,y:235.75},20,cjs.Ease.get(0.5)).to({x:471.85,y:227.65},21,cjs.Ease.get(0.6)).to({x:412,y:233.5},21).wait(1));

	// left_front
	this.instance_5 = new lib.right_f();
	this.instance_5.parent = this;
	this.instance_5.setTransform(483,260,1,1,0,0,0,38,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({x:428.8,y:253},17,cjs.Ease.get(1)).to({x:371.75,y:262.25},20,cjs.Ease.get(0.5)).to({x:311.85,y:254.15},21,cjs.Ease.get(0.6)).to({x:252,y:260},21).wait(1));

	// shadow
	this.instance_6 = new lib.shadow_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(526.65,440.6,0.7662,0.977,0,0,0,317.6,44.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(2).to({scaleX:0.7978,x:327.6},79).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(437,316.5,340.4,167.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/body.png?1559274079453", id:"body"},
		{src:"images/eye.png?1559274079453", id:"eye"},
		{src:"images/eye_2.png?1559274079453", id:"eye_2"},
		{src:"images/head.png?1559274079453", id:"head"},
		{src:"images/left_back_b.png?1559274079453", id:"left_back_b"},
		{src:"images/left_back_s.png?1559274079453", id:"left_back_s"},
		{src:"images/left_front_b.png?1559274079453", id:"left_front_b"},
		{src:"images/left_front_s.png?1559274079453", id:"left_front_s"},
		{src:"images/nose.png?1559274079453", id:"nose"},
		{src:"images/shadow.png?1559274079453", id:"shadow"},
		{src:"images/tail.png?1559274079453", id:"tail"},
		{src:"images/tooth.png?1559274079453", id:"tooth"},
		{src:"images/tooth_s.png?1559274079453", id:"tooth_s"}
	],
	preloads: []
};
