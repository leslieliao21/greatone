...
p.nominalBounds = new cjs.Rectangle(0,0,110,73);
...
(lib.hungry = function() {
	this.initialize(img.hungry);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,51,26);


(lib.hungry_error_1 = function() {
	this.initialize(img.hungry_error_1);
}).prototype = p = new cjs.Bitmap();
...
(lib.sad_1 = function() {
	this.initialize(img.sad_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,27,29);


(lib.sad_2 = function() {
	this.initialize(img.sad_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,27,29);
...
(lib.hungry_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.hungry();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.hungry_1, new cjs.Rectangle(0,0,51,26), null);
...
(lib.eye_h = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_2
	this.instance = new lib.sad_2();
	this.instance.parent = this;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(7).to({_off:false},0).wait(3).to({_off:true},1).wait(7));

	// 圖層_1
	this.instance_1 = new lib.sad_1();
...
}).prototype = getMCSymbolPrototype(lib.cross_1, new cjs.Rectangle(0,0,110,73), null);
...
(lib.元件3 = function(mode,startPosition,loop) {
	...
	// 圖層_1
	this.instance = new lib.hungry_error_1();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件3, new cjs.Rectangle(0,0,300,126), null);
...
(lib.hunger_txt_before = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.元件3();
	this.instance.parent = this;
	this.instance.setTransform(153.05,74.5,1,1,0,0,0,150,63);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.hunger_txt_before, new cjs.Rectangle(3.1,11.5,300,126), null);
...
(lib.元件2 = function(mode,startPosition,loop) {
	...
	// 圖層_2
	this.instance = new lib.hungry_1();
	this.instance.parent = this;
	this.instance.setTransform(61.5,93.1,0.7255,0.7255,0,0,0,25.5,13.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({regY:13,scaleX:1,scaleY:1,y:93,alpha:1},7).wait(9).to({alpha:0},6).to({_off:true},1).wait(3));

	// 圖層_1
	this.instance_1 = new lib.cross_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(55,36.5,1,1,0,0,0,55,36.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1},12).wait(7).to({alpha:0},10).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,110,106);
...
(lib.head_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(262,275.5,1,1,0,0,0,55,36.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30));

	// tooth
	this.instance_1 = new lib.tooth_s_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(54.25,187.75,1,1,0,0,0,85,16);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:6.2371,x:44.3,y:175.5},15).to({rotation:0,x:54.25,y:187.75},14).wait(1));

	// nose
	this.instance_2 = new lib.nose_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(27,149.75,1,1,0,0,0,34.5,18);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regY:18.1,rotation:5.9903,x:19.4,y:143.3},15).to({regY:18,rotation:0,x:27,y:149.25},14).wait(1));

	// eye_h
	this.instance_3 = new lib.eye_h();
	this.instance_3.parent = this;
	this.instance_3.setTransform(56,109,1,1,-12.9889,0,0,13.5,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:14.4595,x:55,y:103.5},15).to({rotation:-12.9889,x:56,y:109},14).wait(1));

	// head
	this.instance_4 = new lib.head_main();
	this.instance_4.parent = this;
	this.instance_4.setTransform(126.05,109.55,1,1,-7.225,0,0,125.9,109.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:126,rotation:1.7199,x:126,y:109.6},15).to({regX:125.9,rotation:-7.225,x:126.05,y:109.55},14).wait(1));

	// tooth_s
	this.instance_5 = new lib.元件4();
	this.instance_5.parent = this;
	this.instance_5.setTransform(23.05,168,1,1,-11.9949,0,0,65,18);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regY:18.1,rotation:10.9761,x:23,y:168.1},15).to({regY:18,rotation:-11.9949,x:23.05,y:168},14).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-46.8,-10.4,363.8,368.2);


// stage content:
(lib.hungry_error = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// hunger_txt
	this.instance = new lib.hunger_txt_before();
	this.instance.parent = this;
	this.instance.setTransform(586,97,1,1,0,0,0,167.5,70);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({x:597,alpha:1},4).to({x:373},75).wait(1));
...
p.nominalBounds = new cjs.Rectangle(434.7,288.5,342.7,195.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/body.png?1561369873966", id:"body"},
		{src:"images/cross.png?1561369873966", id:"cross"},
		{src:"images/head.png?1561369873966", id:"head"},
		{src:"images/hungry.png?1561369873966", id:"hungry"},
		{src:"images/hungry_error_1.png?1561369873966", id:"hungry_error_1"},
		{src:"images/left_back_b.png?1561369873966", id:"left_back_b"},
		{src:"images/left_back_s.png?1561369873966", id:"left_back_s"},
		{src:"images/left_front_b.png?1561369873966", id:"left_front_b"},
		{src:"images/left_front_s.png?1561369873966", id:"left_front_s"},
		{src:"images/nose.png?1561369873966", id:"nose"},
		{src:"images/sad_1.png?1561369873966", id:"sad_1"},
		{src:"images/sad_2.png?1561369873966", id:"sad_2"},
		{src:"images/shadow.png?1561369873966", id:"shadow"},
		{src:"images/tail.png?1561369873966", id:"tail"},
		{src:"images/tooth.png?1561369873966", id:"tooth"},
		{src:"images/tooth_s.png?1561369873966", id:"tooth_s"}
	],
	preloads: []
};
