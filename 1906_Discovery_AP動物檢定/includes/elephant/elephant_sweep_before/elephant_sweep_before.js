...
(lib.clean_txt_before = function() {
	this.initialize(img.clean_txt_before);
}).prototype = p = new cjs.Bitmap();
...
(lib.clean_txt_before_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.clean_txt_before_1, new cjs.Rectangle(0,0,300,126), null);
...
// stage content:
(lib.elephant_sweep_before = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// clean_txt_before
	this.instance = new lib.clean_txt_before_1();
	this.instance.parent = this;
	this.instance.setTransform(270,92,1,1,0,0,0,150,63);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({x:220,alpha:1},4).to({x:450},75).wait(1));
...
p.nominalBounds = new cjs.Rectangle(427,279,350.29999999999995,205);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/angry_1.png?1559724210623", id:"angry_1"},
		{src:"images/angry_2.png?1559724210623", id:"angry_2"},
		{src:"images/body.png?1559724210623", id:"body"},
		{src:"images/clean_txt_before.png?1559724210623", id:"clean_txt_before"},
		{src:"images/head.png?1559724210623", id:"head"},
		{src:"images/left_back_b.png?1559724210623", id:"left_back_b"},
		{src:"images/left_back_s.png?1559724210623", id:"left_back_s"},
		{src:"images/left_front_b.png?1559724210623", id:"left_front_b"},
		{src:"images/left_front_s.png?1559724210623", id:"left_front_s"},
		{src:"images/nose.png?1559724210623", id:"nose"},
		{src:"images/shadow.png?1559724210623", id:"shadow"},
		{src:"images/shit.png?1559724210623", id:"shit"},
		{src:"images/tail.png?1559724210623", id:"tail"},
		{src:"images/tooth.png?1559724210623", id:"tooth"},
		{src:"images/tooth_s.png?1559724210623", id:"tooth_s"}
	],
	preloads: []
};
