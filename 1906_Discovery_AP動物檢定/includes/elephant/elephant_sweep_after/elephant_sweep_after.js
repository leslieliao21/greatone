...
(lib.clean_txt_after = function() {
	this.initialize(img.clean_txt_after);
}).prototype = p = new cjs.Bitmap();
...
(lib.clean_txt_after_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.clean_txt_after();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.clean_txt_after_1, new cjs.Rectangle(0,0,356,149), null);
...
// stage content:
(lib.elephant_sweep_after = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// clean_txt_after
	this.instance = new lib.clean_txt_after_1();
	this.instance.parent = this;
	this.instance.setTransform(270,91.5,1,1,0,0,0,178,74.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({x:225,alpha:1},4).to({x:443},75).wait(1));

	// head
	this.instance_1 = new lib.head_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(365.3,191.5,1,1,0,0,180,139,116.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({x:419.5,y:184.5},17,cjs.Ease.get(1)).to({x:476.55,y:193.75},20,cjs.Ease.get(0.5)).to({x:536.45,y:185.65},21,cjs.Ease.get(0.6)).to({x:596.3,y:191.5},21).wait(1));

	// left_front
	this.instance_2 = new lib.left_front_b_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(318.3,284,1,1,0,0,180,38,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({x:372.5,y:277},17,cjs.Ease.get(1)).to({x:429.55,y:286.25},20,cjs.Ease.get(0.5)).to({x:489.45,y:278.15},21,cjs.Ease.get(0.6)).to({x:549.3,y:284},21).wait(1));

	// left_back
	this.instance_3 = new lib.left_back();
	this.instance_3.parent = this;
	this.instance_3.setTransform(134.3,247.5,1,1,0,0,180,52,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({x:188.5,y:240.5},17,cjs.Ease.get(1)).to({x:245.55,y:249.75},20,cjs.Ease.get(0.5)).to({x:305.45,y:241.65},21,cjs.Ease.get(0.6)).to({x:365.3,y:247.5},21).wait(1));

	// body
	this.instance_4 = new lib.body_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(224.8,228.5,1,1,0,0,180,152.5,115.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({x:279,y:221.5},17,cjs.Ease.get(1)).to({x:336.05,y:230.75},20,cjs.Ease.get(0.5)).to({x:395.95,y:222.65},21,cjs.Ease.get(0.6)).to({x:455.8,y:228.5},21).wait(1));

	// left_back
	this.instance_5 = new lib.right_back();
	this.instance_5.parent = this;
	this.instance_5.setTransform(181.3,233.5,1,1,0,0,180,52,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({x:235.5,y:226.5},17,cjs.Ease.get(1)).to({x:292.55,y:235.75},20,cjs.Ease.get(0.5)).to({x:352.45,y:227.65},21,cjs.Ease.get(0.6)).to({x:412.3,y:233.5},21).wait(1));

	// left_front
	this.instance_6 = new lib.right_f();
	this.instance_6.parent = this;
	this.instance_6.setTransform(341.3,260,1,1,0,0,180,38,22);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(2).to({x:395.5,y:253},17,cjs.Ease.get(1)).to({x:452.55,y:262.25},20,cjs.Ease.get(0.5)).to({x:512.45,y:254.15},21,cjs.Ease.get(0.6)).to({x:572.3,y:260},21).wait(1));

	// shadow
	this.instance_7 = new lib.shadow_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(297.65,440.6,0.7662,0.977,0,0,180,317.6,44.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(2).to({scaleX:0.7978,x:496.7},79).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(437,267,340.29999999999995,217);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/body.png?1559725132528", id:"body"},
		{src:"images/clean_txt_after.png?1559725132529", id:"clean_txt_after"},
		{src:"images/eye.png?1559725132529", id:"eye"},
		{src:"images/eye_2.png?1559725132529", id:"eye_2"},
		{src:"images/head.png?1559725132529", id:"head"},
		{src:"images/left_back_b.png?1559725132529", id:"left_back_b"},
		{src:"images/left_back_s.png?1559725132529", id:"left_back_s"},
		{src:"images/left_front_b.png?1559725132529", id:"left_front_b"},
		{src:"images/left_front_s.png?1559725132529", id:"left_front_s"},
		{src:"images/nose.png?1559725132529", id:"nose"},
		{src:"images/shadow.png?1559725132529", id:"shadow"},
		{src:"images/tail.png?1559725132529", id:"tail"},
		{src:"images/tooth.png?1559725132529", id:"tooth"},
		{src:"images/tooth_s.png?1559725132529", id:"tooth_s"}
	],
	preloads: []
};
