...
(lib.mud_txt_before = function() {
	this.initialize(img.mud_txt_before);
}).prototype = p = new cjs.Bitmap();
...
(lib.mud_txt_before_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.mud_txt_before_1, new cjs.Rectangle(0,0,300,126), null);
...
// stage content:
(lib.elephant_mud_beforel = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// mud_txt_before
	this.instance = new lib.mud_txt_before_1();
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(437,282,340.4,202);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/body.png?1559280727804", id:"body"},
		{src:"images/eye.png?1559280727804", id:"eye"},
		{src:"images/eye_2.png?1559280727804", id:"eye_2"},
		{src:"images/head.png?1559280727804", id:"head"},
		{src:"images/left_back_b.png?1559280727804", id:"left_back_b"},
		{src:"images/left_back_s.png?1559280727804", id:"left_back_s"},
		{src:"images/left_front_b.png?1559280727804", id:"left_front_b"},
		{src:"images/left_front_s.png?1559280727804", id:"left_front_s"},
		{src:"images/mud_txt_before.png?1559280727804", id:"mud_txt_before"},
		{src:"images/nose.png?1559280727804", id:"nose"},
		{src:"images/shadow.png?1559280727804", id:"shadow"},
		{src:"images/tail.png?1559280727804", id:"tail"},
		{src:"images/tooth.png?1559280727804", id:"tooth"},
		{src:"images/tooth_s.png?1559280727804", id:"tooth_s"}
	],
	preloads: []
};
